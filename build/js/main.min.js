"use strict";class ProductItem{constructor(t,i="img/noimage.jpg",e="Product Name",s="Is unknown"){this.img=t.img||i,this.title=t.title||e,this.price=t.price||s}render(){return`<div class='products__item'>
          ...
          </div>`}}class ProductsList{constructor(t=".products"){this.container=t,this.goods=[{img:"img/good-1.jpg",title:"Shirt",price:150},{img:"img/good-2.jpg",title:"Socks",price:50},{img:"img/good-3.jpg",title:"Jacket",price:350},{img:"img/good-4.jpg",title:"Shoes",price:250},{}]}render(){const t=document.querySelector(this.container);for(var i of this.goods){const e=new ProductItem(i);t.insertAdjacentHTML("beforeend",e.render())}}}let list=new ProductsList;list.render();class CartItem{constructor(t){this.img=t.img,this.title=t.title,this.price=t.price}}class Cart{add(){}delite(){}increaseProductQuantity(){}reduceProductQuantity(){}}
